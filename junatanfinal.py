...
query = """SELECT * 
           ...
           WHERE (username IS NOT NULL) AND (grade IS NOT NULL) AND (course_id IS NOT NULL) AND (course IS NOT NULL) AND (gender IS NOT NULL) AND (year_of_birth IS NOT NULL) AND (csp IS NOT NULL) AND (level_of_education IS NOT NULL);"""
