...
def main():
    st.title("Prédiction de notes")

    # Sidebar pour charger le modèle
    st.sidebar.title("Charger le modèle")
    model_path = st.sidebar.file_uploader("Sélectionnez le modèle à charger", type="joblib")
    if model_path:
